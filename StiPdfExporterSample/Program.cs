...
var mrtFileContent = File.ReadAllBytes($@"F:\Pdf\StimulsoftReports.Engine.NetCore.PersianPdfExporter\StiPdfExporterSample\MrtFiles\Report.mrt");

StiReportEngine.StartReport()
               .SetMrtFile(mrtFileContent)
               .AddDataContent("Data" , datas)
               .Render()
